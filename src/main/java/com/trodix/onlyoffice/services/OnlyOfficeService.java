...
import com.trodix.onlyoffice.dto.requests.OnlyOfficeDocumentType;
...
public class OnlyOfficeService {
    ...
    @Value("${onlyoffice.app-server-base-url}")
    ...
    public void updateDocument(String documentId, String revision, String url) {
        ...
        try (InputStream is = new URL(url).openConnection().getInputStream()) {
            onlyOfficeDocumentService.updateContent(officeDocument, is.readAllBytes());
        } catch (IOException e) {
